        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VideoPostMetadata_Width = table.Column<int>(type: "INTEGER", nullable: true),
                    VideoPostMetadata_Height = table.Column<int>(type: "INTEGER", nullable: true),
                    VideoPostMetadata_Length = table.Column<TimeSpan>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostMetadata", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PostMetadata_Posts_Id",
                        column: x => x.Id,
                        principalTable: "Posts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TagAliases_Tags_TargetId",
                        column: x => x.TargetId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TagImplications", x => new { x.SourceId, x.TargetId });
                    table.ForeignKey(
                        name: "FK_TagImplications_Tags_SourceId",
                        column: x => x.SourceId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TagImplications_Tags_TargetId",
                        column: x => x.TargetId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TagImplications_TargetId",
